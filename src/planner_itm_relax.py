...
class Planner:
    ...
    def setup(self):
        ...
        for i in range(self.N + 1):
            ...
            lbx = lbx + [
                -np.inf, -np.inf, 0.5, -np.inf, -np.inf, -np.inf, -1.0, -1.0,
                -1.0, -1.0, -omega_max_xy, -omega_max_xy,
                -self.quad.omega_max_z
            ]
            ubx = ubx + [
                np.inf, np.inf, 100.0, np.inf, np.inf, np.inf, 1.0, 1.0, 1.0,
                1.0, omega_max_xy, omega_max_xy, self.quad.omega_max_z
            ]
