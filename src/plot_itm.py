...
class CallbackPlot(ca.Callback):
    def __init__(self,
        ...
        for plot in [
                self.pos, self.vel, self.ori, self.rate, self.inputs, self.prog
        ]:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Plots a given trajectory from .csv format.')
    ...
    print("Plotting trajectory with %d waypoints and %d nodes." %
          (traj.NW, traj.N))
