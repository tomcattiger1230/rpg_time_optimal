...
class Trajectory:
    ...
    def parse(self):
        ...
        self.mu = self.x[(self.N + 1) * self.NU + 1 +
                         (self.N + 1) * self.NX:(self.N + 1) * self.NU + 1 +
                         (self.N + 1) * self.NX + (self.N + 1) * self.NW]
        self.mu = self.mu.reshape(-1, self.NW)
        self.mu = self.mu.T
        self.nu = self.x[(self.N + 1) * self.NU + 1 + (self.N + 1) * self.NX +
                         (self.N + 1) * self.NW:(self.N + 1) * self.NU + 1 +
                         (self.N + 1) * self.NX + (self.N + 1) * self.NW +
                         self.NW * self.N]
        self.nu = self.nu.reshape(-1, self.NW)
        self.nu = self.nu.T
        self.tau = self.x[(self.N + 1) * self.NU + 1 + (self.N + 1) * self.NX +
                          (self.N + 1) * self.NW +
                          self.NW * self.N:(self.N + 1) * self.NU + 1 +
                          (self.N + 1) * self.NX + (self.N + 1) * self.NW +
