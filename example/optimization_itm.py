...
from planner_itm_relax import Planner
from trajectory_itm import Trajectory
from plot_itm import CallbackPlot
...
traj.save(BASEPATH + '/example/result_cpc_format_itm.csv', False)
traj.save(BASEPATH + '/example/result_itm.csv', True)
